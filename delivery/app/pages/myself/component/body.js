    ...
    render() {
        return (
            <View style={{ flex: 1, marginTop: unitWidth * 40 }}>
                ...
                <TouchableWithoutFeedback onPress={() => NavigationService.navigate('')} >
                    <View style={styleBody.view}>
                        <FastImage source={require('../../../res/shenfenrenzheng.png')} style={styleBody.image1} />
                        <View style={styleBody.viewC}>
                            <Text style={styleBody.text}>认证</Text>
