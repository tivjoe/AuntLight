            ...
            <View style={{ flex: 1, marginTop: 10 }} >
                ...
                <View style={styleInfo.itemView}>
                    ...
                    <View style={styleInfo.textView}>
                        <Text style={styleInfo.text}>{this.store.info.finish_order_time == null ? "预计送达15:45" : this.store.finish_order_time}</Text>
                    </View>
                </View>
                ...
                <View style={styleInfo.itemView}>
                    ...
                    <View style={styleInfo.textView}>
                        <Text style={styleInfo.text}>¥ {this.store.info.order_money}</Text>
                        <Text style={{ fontSize: fontscale * 12 }} > (含配送费¥{this.store.info.user_pay_freight})</Text>
                    </View>
                </View>
                ...
                <View style={styleInfo.itemView}>
                    ...
                    <View style={styleInfo.textView}>
                        <Text style={styleInfo.text}>{this.store.info.remake == null ? "无" : this.store.info.contact_remake}</Text>
                    </View>
                </View>
                ...
                <View style={styleInfo.itemView}>
                    ...
                    <View style={styleInfo.textView}>
                        <Text style={styleInfo.text}>{this.store.info.order_id}</Text>
                    </View>
                </View>

                <View style={styleInfo.itemAddress}>
                    <Text style={styleInfo.textTitle}>收货地址</Text>
                    <View style={styleInfo.viewAddress}>
                        <Text style={{ fontSize: fontscale * 12 }}>{this.store.info.contact_street}</Text>
                        <Text style={{ fontSize: fontscale * 12, marginTop: unitWidth * 10 }}>{this.store.info.contact_name}   {this.store.info.contact_phone}</Text>
                    </View>
                </View>

                <View style={styleInfo.itemView}>
                    <View style={styleInfo.viewSeller} >
                        <Text style={styleInfo.text}>联系商家</Text>
